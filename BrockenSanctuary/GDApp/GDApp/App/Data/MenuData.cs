...
namespace GDLibrary
{
    public class MenuData
    {
        ...
        public static string StringMenuRestartYes = "yes";
        public static string StringMenuRestartNo = "no";

        public static string StringMenuLoseRestart = "restart";
        public static string StringMenuLoseMainMenu = "main menu";
        #endregion
        ...
        public static int TextureIndexRestartMenu = 4;
        public static int TextureIndexLoseMenu = 5;
        public static int TextureIndexWinMenu = 6;
        ...
        public static Rectangle BoundsMenuRestartYes = new Rectangle(510, 470, 50, 40);
        public static Rectangle BoundsMenuRestartNo = new Rectangle(520, 600, 35, 40);

        public static Rectangle BoundsMenuLoseRestart = new Rectangle(480, 470, 130, 40);
        public static Rectangle BoundsMenuLoseMainMenu = new Rectangle(470, 600, 150, 40);
